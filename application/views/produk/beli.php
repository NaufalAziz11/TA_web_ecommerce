                    ...
                    <div class="col-md-10 heading-section text-left ftco-animate ml-5">
                        ...
                        <div class="row ml-2">
                            <div class="col-md-2 col-lg-3 ftco-animate ">
                                <div>
                                    <h6 class="text-secondary"><b>Metode Pengiriman</b></h6><br>
                                    <h6 class="text-secondary"><b>Metode Pembayaran</b></h6>
                            ...
                            <div class="col-lg-6">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="#">JNT</a>
                                        <a class="dropdown-item" href="#">Bayar Ditempat</a>
                                    </div>
                                </div>
                                <br>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#">Transfer BRI</a>
                                        <a class="dropdown-item" href="#">Bayar Ditempat</a>
                                    </div>
                                </div>
                            </div>
