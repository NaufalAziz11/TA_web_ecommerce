                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <?php if ($this->session->userdata('email')) { ?>
                            <form action="<?= base_url(); ?>ongkir/edit_ongkir" method="POST" enctype="multipart/form-data">
                                <br>
                                <div class="form-group">
                                    <input type="hidden" class="form-control" name="email" id="email" value="<?= $user_login['email']; ?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_penerima" id="nama_penerima" value="<?=$alamat['nama_penerima'] ?>" placeholder="ex. Bambang ">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="no_telepon" id="no_telepon" value="<?=$alamat['no_telepon'] ?>" placeholder="ex. 085869277826">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="jenis_alamat" id="jenis_alamat" value="<?=$alamat['jenis_alamat'] ?>" placeholder="ex. Rumah">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" id="alamat_lengkap" name="alamat_lengkap"  rows="3" placeholder="ex. Ds.Kalisari, Kec.Blado, Kab.Batang ,RT.04 RW.01"><?=$alamat['alamat_lengkap'] ?></textarea>
